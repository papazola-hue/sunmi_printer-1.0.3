...
public class SunmiPrinterPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    switch (call.method) {
      ...
      case "SET_FONT_BOLD":
        Boolean fontBold = call.argument("fontBold");
        sunmiPrinterMethod.setFontBold(fontBold);
        result.success(true);
        break;
      ...
      case "PRINT_COLUMN":
        ...
        sunmiPrinterMethod.printColumnText(data, columnWidth, columnAlignment);
        result.success(true);
        break;
      ...
      case "PRINT_COLUMN_LIST":
        ...
        int[] columnWidthList = call.argument("columnWidth");
        int[] columnAlignmentList = call.argument("columnAlignment");
        sunmiPrinterMethod.printColumnText(stringColumns, columnWidthList, columnAlignmentList);
        result.success(true);
        break;
